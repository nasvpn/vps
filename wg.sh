...
echo -e "${Info} Wireguard VPS AutoScript by auf"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/nasvpn/vps/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/nasvpn/vps/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/nasvpn/vps/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/nasvpn/vps/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
